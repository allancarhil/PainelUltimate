    ...
    <div class="card-header" style="background-color: #6ab2ec">
        <table class="table table-borderless justify">
            <tr>
                ...
                <th scope="col" class="d-flex justify-content-end"><a class="btn btn-light" href="{{url('uc14Resumo/form')}}" style="color:#000000">Voltar</a></th>
            </tr>
        </table>
        ...
        <div class="card-body">
            ...
            <table class="table">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <form action="uc14Resumo/{{$d->id}}/pdf" method="post" target="_blank">
                                @csrf
