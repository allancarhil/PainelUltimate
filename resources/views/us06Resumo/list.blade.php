    ...
    <div class="row justify-content-top">
        <div class="row-md-12">
            ...
            <div class="card-header" style="background-color: #6ab2ec">
                <a href="{{url('us06Resumo')}}" style="color:#000000"><b>Resumo US06</b></a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <br/>
                        ...
                        <thead>
                            <tr style="background-color: #6ab2ec"  >
                                <th scope="col" width="575px">US-06</th>
                            </tr>
                        </thead>
                    ...
                    <table class="table-bordered">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="Nº Tanques açude Interno" value="" justify-center></td>                            
                                        <td><input type="text" name="Nº Tanques açude Restaurante" value="" justify-center></td>  
                            </tr>
                    </table>
                    <table class="table-bordered">
