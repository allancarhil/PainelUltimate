    ...
    <div class="card-header" style="background-color: #6ab2ec">
        <table class="table table-borderless justify">
            <tr>
                ...
                <th scope="col" class="d-flex justify-content-end"><a class="btn btn-light" href="{{url('uc06Resumo/form')}}" style="color:#000000">Voltar</a></th>
            </tr>
        </table>
            ...
            <table class="table">
                ...
                <table class="table">
                    ...
                    <tbody style="font-size: 20px; font-weight:500;">
                        <tr>
                            $total = $d->b0NumViagens+$d->b1NumViagens+
                            <td>{{$total}}</td>
