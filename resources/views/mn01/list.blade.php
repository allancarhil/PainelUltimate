...
<tbody>
    ...
    <tr>
        <form action="/mn01/excel/{{$d->id}}" method="post" target="_blank">
            @csrf 
            <button type="submit" class="btn" style="background-color: #6ab2ec;margin-right:2px; ">Exportar Excel</button>
        </form>
    </tr>
    <tr>
    <a href="/mn01/envio-email" class="btn" style="background-color: #6ab2ec;" target="_blank">Enviar por email</a>
    </tr>
</tbody>
</table>
</div>
...
@endforeach
<form action="/mn01/excel/data/{{$d->data}}" method="post" target="_blank">
@csrf
